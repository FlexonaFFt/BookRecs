...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--books-raw-uri", default="data/raw_data/books.json.gz")
    parser.add_argument("--interactions-raw-uri", default="data/raw_data/interactions.json.gz")
    parser.add_argument("--s3-prefix", default="s3://bookrecs/datasets/goodreads_ya")
