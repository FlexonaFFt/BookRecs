...
- **Бизнес-цель `Product Owner`**  
  Сейчас пользователю сложно быстро найти «свою» книгу из большого каталога → он тратит время или уходит без покупки. Мы хотим упростить этот выбор с помощью рекомендаций.


- **Почему станет лучше, чем сейчас, от использования ML `Product Owner` & `Data Scientist`**  
  Повысить конверсию в покупку, сократив время, необходимое пользователю для нахождения подходящей книги (снижение эффекта choice overload).


- **Что будем считать успехом итерации с точки зрения бизнеса `Product Owner`**  
  Поддержать продажи новинок и товаров из «длинного хвоста» за счёт улучшенного discovery и доступности каталога.
